defmodule TwixWeb.CoreComponents do
  @moduledoc """
        ...
        >
          <tr :for={row <- @rows} id={@row_id && @row_id.(row)} class="group hover:bg-zinc-50">
            ...
            <td :if={@action != []} class="relative w-14 p-0">
              <div class="relative whitespace-nowrap py-4 text-right text-sm font-medium flex">
  ...
  def list(assigns) do
    ~H"""
    <div class="mt-14">
      <dl class={["-my-4", @divider && "divide-y divide-zinc-100"]}>
